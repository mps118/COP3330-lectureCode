/*
                        Miles Sharpton
                            COP3330-301
    This program will find the roots of a quatric funtion
*/
...
int main()
{
    ...
    {
        cout <<left<< "The given quadratic equation has no real solution, the descriminant value is; "  << descriminant << endl;
    }
    return 0;
    //tesing git changes
}